...
import fr.chicodouille.seridium.gui.NoNameBagGUIGuiWindow;
import fr.chicodouille.seridium.gui.NoNameBagGUIGui;
import fr.chicodouille.seridium.SeridiumodModElements;

@SeridiumodModElements.ModElement.Tag
public class NoNameBagItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:no_name_bag")
	public static final Item block = null;

	public NoNameBagItem(SeridiumodModElements instance) {
		super(instance, 55);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof NoNameBagGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Amanium Bag");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new NoNameBagGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
