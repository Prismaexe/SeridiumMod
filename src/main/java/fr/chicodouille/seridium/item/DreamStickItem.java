...
import fr.chicodouille.seridium.procedures.DreamStickRightclickedProcedure;
...
public class DreamStickItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:dream_stick")
	public static final Item block = null;

	public DreamStickItem(SeridiumodModElements instance) {
		super(instance, 84);
	}
