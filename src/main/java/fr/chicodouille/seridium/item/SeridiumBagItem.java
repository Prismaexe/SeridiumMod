...
import fr.chicodouille.seridium.gui.SeridiumBagGGuiWindow;
import fr.chicodouille.seridium.gui.SeridiumBagGGui;
import fr.chicodouille.seridium.SeridiumodModElements;

@SeridiumodModElements.ModElement.Tag
public class SeridiumBagItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:seridium_bag")
	public static final Item block = null;

	public SeridiumBagItem(SeridiumodModElements instance) {
		super(instance, 50);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof SeridiumBagGGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Seridium Bag");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new SeridiumBagGGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
