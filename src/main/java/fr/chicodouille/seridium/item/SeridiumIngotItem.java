...
public class SeridiumIngotItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:seridium_ingot")
	public static final Item block = null;

	public SeridiumIngotItem(SeridiumodModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("seridium_ingot");
		}
