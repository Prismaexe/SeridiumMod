...
public class AgmeriteHoeItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:agmerite_hoe")
	public static final Item block = null;

	public AgmeriteHoeItem(SeridiumodModElements instance) {
		super(instance, 39);
	}
