...
public class BrushItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:brush")
	public static final Item block = null;

	public BrushItem(SeridiumodModElements instance) {
		super(instance, 88);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(SeridiumItemGroup.tab).maxDamage(1));
		}
