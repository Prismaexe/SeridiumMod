...
public class ParcheminSmeltItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:parchemin_smelt")
	public static final Item block = null;

	public ParcheminSmeltItem(SeridiumodModElements instance) {
		super(instance, 96);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("parchemin_smelt");
		}
