...
public class FragmentAgmeriteItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:fragment_agmerite")
	public static final Item block = null;

	public FragmentAgmeriteItem(SeridiumodModElements instance) {
		super(instance, 67);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fragment_agmerite");
		}
