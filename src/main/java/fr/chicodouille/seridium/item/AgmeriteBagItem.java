...
import fr.chicodouille.seridium.gui.AgmeriteBagGUIGuiWindow;
import fr.chicodouille.seridium.gui.AgmeriteBagGUIGui;
import fr.chicodouille.seridium.SeridiumodModElements;

@SeridiumodModElements.ModElement.Tag
public class AgmeriteBagItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:agmerite_bag")
	public static final Item block = null;

	public AgmeriteBagItem(SeridiumodModElements instance) {
		super(instance, 53);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof AgmeriteBagGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Agmerite Bag");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new AgmeriteBagGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
