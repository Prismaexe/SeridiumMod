...
public class OpaleIngotItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:opale_ingot")
	public static final Item block = null;

	public OpaleIngotItem(SeridiumodModElements instance) {
		super(instance, 111);
	}
