...
public class HeartOfTheForestItem extends SeridiumodModElements.ModElement {
	@ObjectHolder("seridiumod:heart_of_the_forest")
	public static final Item block = null;

	public HeartOfTheForestItem(SeridiumodModElements instance) {
		super(instance, 101);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("heart_of_the_forest");
		}
