...
public class SnailEntity extends SeridiumodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("snail").setRegistryName("snail");

	public SnailEntity(SeridiumodModElements instance) {
		super(instance, 81);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SnailGeckolibEntity());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(SeridiumItemGroup.tab)).setRegistryName("snail_spawn_egg"));
	}
