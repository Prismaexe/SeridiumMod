...
import fr.chicodouille.seridium.item.DoeLeatherItem;
import fr.chicodouille.seridium.SeridiumodModElements;

@SeridiumodModElements.ModElement.Tag
public class DoeEntity extends SeridiumodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("doe").setRegistryName("doe");

	public DoeEntity(SeridiumodModElements instance) {
		super(instance, 99);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DoeGeckolibEntity());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(SeridiumItemGroup.tab)).setRegistryName("doe_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity implements IAnimatable {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(DoeLeatherItem.block));
		}
